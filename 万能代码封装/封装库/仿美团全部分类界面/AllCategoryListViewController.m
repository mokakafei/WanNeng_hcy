...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"全部分类";
    self.view.backgroundColor = XMGRGBColor(242, 242, 242);
...
- (void)setupCollectionView {
    ...
    layout.itemSize = CGSizeMake((XMGScreenW - 20.0)/ 4, 38);
    layout.minimumLineSpacing = 0;
    layout.minimumInteritemSpacing = 0;
    layout.headerReferenceSize = CGSizeMake((XMGScreenW - 20.0), 45);
    layout.footerReferenceSize = CGSizeMake((XMGScreenW - 20.0), 10);
    
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, XMGScreenW, XMGScreenH ) collectionViewLayout:layout];
