...
- (void)setUpFistSearchBar {
    ...
    self.firstSearchBar.frame = CGRectMake(0, 50+navHeight, UIScreenWidth, 44);
...
- (void)setUpSecondSearchBar {
    ...
    self.secondSearchBar.frame = CGRectMake(0, 120+navHeight, UIScreenWidth, 44);
...
- (void)setUpThirdSearchBar {
    ...
    self.thirdSearchBar.frame = CGRectMake(0, 190+navHeight, UIScreenWidth, 44);
...
- (void)setUpForthSearchBar {
    ...
    self.forthSearchBar.frame = CGRectMake(0, 260+navHeight, UIScreenWidth, 44);
...
- (void)setUpFifthSearchBar {
    ...
    self.fifthSearchBar.frame = CGRectMake(0, 330+navHeight, UIScreenWidth, 44);
