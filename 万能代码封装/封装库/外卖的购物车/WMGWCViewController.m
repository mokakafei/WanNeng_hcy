//
//  WMGWCViewController.h
//  万能代码封装
//
//  Created by hcy on 2017/8/28.
...
@interface WMGWCViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UITableViewDataSource,UITableViewDelegate,numberDelegate>{
    NSArray *dataArray;
    UILabel         *_shopNumber;
...
@implementation WMGWCViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    dataArray = @[@"零食",@"粮油",@"饭菜",@"美妆",@"奶制品"];
    ...
    priceBut.backgroundColor = [UIColor redColor];
    [priceBut setTitle:@"确认付款" forState:UIControlStateNormal];
